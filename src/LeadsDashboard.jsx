...
export default function LeadsDashboard() {
  ...
  // EXPANDED: All valid stages available to the Executive in their workflow dropdown
  ...
  return (
    <div style={{ padding: '24px', fontFamily: 'sans-serif', backgroundColor: '#f4f6f9', minHeight: '100vh', boxSizing: 'border-box' }}>
      ...
      {/* Dynamic CSS Injector for Layout Fluidity across Screen Ratios */}
      <style>{`
        .crm-responsive-row {
          display: grid;
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  {lead.status === 'New' ? (
                    <button onClick={() => handleGrabLead(lead.id)} style={{ backgroundColor: '#2563eb', color: '#fff', padding: '8px 14px', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: '500', width: '100%' }}>
                      Grab Lead ⚡
                    </button>
                  ) : (
                    <select 
                      ...
                      style={{ padding: '8px 10px', borderRadius: '6px', border: '1px solid #cbd5e1', backgroundColor: '#fff', fontSize: '13px', fontWeight: '500', cursor: 'pointer', width: '100%' }}
                    >
